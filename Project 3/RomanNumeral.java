...
public class RomanNumeral {
    ...
    * @return the string representation of the RomanNumeral object in the format: Roman numeral (Arabic value)
    */
   @Override
   ...
   /**
    * Returns the Arabic value equivalent for any given single character Roman numeral
